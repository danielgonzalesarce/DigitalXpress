<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-6">
        ...
        <div class="space-y-4">
            ...
            <!-- Google Register Button - Redirige a página de desarrollo -->
            <a href="{{ route('pages.development') }}" class="flex w-full items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 transition-colors">
